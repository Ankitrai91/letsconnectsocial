      ...
      {posts.length > 0 ? posts.reverse().map((post, id) => {
        ...
        return (<div className="Post" id={id}>
          ...
          <div className="postReact">
            <img src={post._doc.likedUser.includes(localStorage.getItem("userId")) ? Heart : NotLike} alt="" style={{ cursor: "pointer" , height:'20px' , width:'20px' }} onClick={() => handleLikes(post)} />
            <img src={Comment} alt="" style={{ cursor: "pointer" , height:'20px' , width:'20px' }} />
            <img src={Share} alt="" style={{ cursor: "pointer" , height:'20px' , width:'20px' }} />
          </div>
